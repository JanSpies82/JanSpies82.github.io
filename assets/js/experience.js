...
const exp = [
  ...
  },
  {
    ...
    time: "(Sep - Dec, 2023)",
    desp: "<li>Worked part time in Business Process Management team</li> <li>Worked on Java Spring Boot applications in an Agile team</li>",
  },
  {
    title: "Tutor",
    cardImage: "assets/images/experience-page/up.png",
    place: "University of Pretoria",
    time: "(Feb - Nov, 2023)",
    desp: "<li>Tutored second year data structures and algorithms course (COS 212) as well as first year program design (COS 110)</li> <li>Included one on one consultations, practical assistance and weekly tutorial script marking</li>",
  },
  {
    title: "Substitute High School Teacher",
    cardImage: "assets/images/experience-page/linden.jpg",
    place: "Hoërskool Linden",
    time: "(Jan - Feb, 2023)",
    desp: "<li>Taught IT for gr 10-12</li> <li>Taught CAT for gr 9</li> <li>Included full time teaching of classes with up to 28 learners at a time</li>",
  },
];
